...
public class CHBlockEntityRenderer<T extends BlockEntity> implements BlockEntityRenderer<T> {
    public CHBlockEntityRenderer(BlockEntityRendererProvider.Context p_i226007_1_) {
    }
