...
public class FleshMaiden extends Monster {
    ...
    protected void registerGoals() {
        this.goalSelector.addGoal(1, new LongAttackGoal(this, 1.2D, false));
        this.goalSelector.addGoal(2, new MaidenAttackGoal(this, 1.2D, false));
    ...
    public void addAdditionalSaveData(CompoundTag pCompound) {
        ...
        pCompound.putInt("LongAttackCool", this.longAttackCool);
    }

    public void readAdditionalSaveData(CompoundTag pCompound) {
        super.readAdditionalSaveData(pCompound);
        if (pCompound.contains("LongAttackCool")){
            this.longAttackCool = pCompound.getInt("LongAttackCool");
        }
    }
    ...
    public int getAnimationState(String animation) {
        if (Objects.equals(animation, IDLE)){
            ...
            return 1;
        } else if (Objects.equals(animation, LONG_ATTACK)){
            return 2;
        ...
        if (ANIM_STATE.equals(p_219422_)) {
            if (this.level().isClientSide){
                switch (this.entityData.get(ANIM_STATE)){
                    ...
                    case 2:
                        this.stopAllAnimation();
                        this.longAttackAnimationState.startIfStopped(this.tickCount);
                        break;
                    case 3:
                        this.stopAllAnimation();
    ...
    public static class MaidenAttackGoal extends ModMeleeAttackGoal {
    ...
    public static class LongAttackGoal extends ModMeleeAttackGoal{
        public FleshMaiden maiden;
        ...
        protected double getAttackReachSqr(LivingEntity target) {
            return this.defaultAttackReachSqr(target) * 4.0D;
        }
    }
}
